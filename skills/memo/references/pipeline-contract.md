...
Single source of truth for the legal-memo-writer runtime. All other docs (README, `skills/memo/SKILL.md`, `skills/continue/SKILL.md`, `skills/revision-loop/SKILL.md`, `skills/memo/references/modes.md`, `skills/memo/references/always-deliver.md`, `skills/memo/state-schema.md`, agent prompts) cite this file as canonical instead of restating. If those docs ever appear to diverge from this file, **this file wins** — file a follow-up to bring the diverging doc back in sync.
